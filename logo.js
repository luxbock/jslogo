...
function LogoInterpreter(turtle, stream, savehook)
{
  ...
  def(["forward", "fd"], function(a) { return turtle.forward(aexpr(a)); });
  def(["back", "bk"], function(a) { return turtle.back(aexpr(a)); });
  def(["left", "lt"], function(a) { return turtle.left(aexpr(a)); });
  def(["right", "rt"], function(a) { return turtle.right(aexpr(a)); });
